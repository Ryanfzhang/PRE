...
for i in tqdm(range(step)):
    ...
    imputed_data = model.impute(data_graph, data_mask_graph, adj, node_type, 20)
...
imputed_datas = torch.zeros(964,20,12,1,60,96)
imputed_datas[:,:,:,:,is_sea]=imputed_datas_graph
new_data_path="/home/mafzhang/data/PRE/8d/missing_0.1_in_12_out_1_1_imputed_graph_gt.pk"
